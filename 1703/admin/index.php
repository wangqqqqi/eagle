...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/web/1703/static/css/bootstrap.css">
    <style>
        html,body{
...
<body>
   ...
   <div class="container header">
           <h1>
              <span class="welcome"> 欢迎来到xxx管理系统</span>
       ...
       <div class="btn btn-info"><a href="logout.php">安全退出</a></div>
       <div class="btn btn-info"><a href="../index/index.php" target="_blank">查看首页</a></div>
   </div>
 ...
 <a href="addUser.php" target="right">添加管理员</a>
                  ...
                  <li class="opts">
                      ...
                      <ul class="son">
                          <li>查看banner</li>
                          <li>
                              <a href="addbanner.php" target="right">
                                  添加banner
                              </a>
                          </li>
                      </ul>
